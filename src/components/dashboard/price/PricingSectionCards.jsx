      ...
      <div className="container py-12 lg:py-12">
        ...
        <div className="max-w-2xl mx-auto mb-10 text-center lg:mb-14">
          ...
          <p className="mt-1 text-muted-foreground">
            Seja qual for seu status, nossas ofertas evoluem de acordo com suas necessidades.
          </p>
        </div>
        {/* End Title */}
        {/* Switch */}
        ...
        <div className="grid gap-6 mt-12 sm:grid-cols-2 lg:grid-cols-4 lg:items-center">
          ...
          <Card className="border-primary">
            ...
            <CardDescription className="w-11/12 mx-auto text-center">
